...
function UserDashboard() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert("Request Sent! / ඉල්ලීම යොමු කරන ලදී.");
  };
  ...
  return (
    <div className="dashboard-wrapper">
      <div className="welcome-msg">
        <h2>Hello, User! 👋</h2>
        <p>අපද්‍රව්‍ය එකතු කිරීමේ නව ඉල්ලීමක් සිදු කිරීමට පහත පෝරමය පුරවන්න.</p>
      </div>
      ...
      <div className="dash-card">
        <div className="flex-container">
          ...
          <div className="map-box">
            ...
            <p className="map-info">📍 කරුණාකර අපද්‍රව්‍ය ඇති ස්ථානය සිතියම මත ලකුණු කරන්න.</p>
          </div>

          {/* පෝරමය (Request Form) */}
          <div className="form-box">
            <h3 className="form-head">Request Collection</h3>
            <form onSubmit={handleSubmit}>
              ...
              <div className="input-group">
                <label>Upload Photo / පින්තූරය</label>
